...
**PDF Export**:
The batch conversion of all generated markdown reports (both raw and AI-condensed) into PDF format, saved to a dedicated `reports/pdf/` subdirectory.
_Avoid_: print output, document render.
...
- [ ] Issue 010: Export Reports to PDF from Console Wizard
